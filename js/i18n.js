export const translations = {
    es: {
        ...
        amountLabel_g: "Cantidad (gramos)",
        amountLabel_ml: "Cantidad (mililitros)",
        unit_g: "g",
        unit_ml: "ml",
        ...
        emptySelection: "Añade alimentos para empezar a calcular",
        // Menu Builder
        quickStart: "¿Por dónde empezamos?",
        quickStartDesc: "Selecciona una categoría o busca tu ingrediente",
        tipPotassium: "💡 Tip: Remoja las legumbres y tubérculos para reducir el potasio.",
        catFruitsMenu: "Frutas",
        catVegetablesMenu: "Verduras",
        catProteinsMenu: "Proteínas",
        catDairyMenu: "Lácteos",
        catCerealsMenu: "Cereales",
        catDrinksMenu: "Bebidas",
        back: "Volver",
        results: "Resultados",
        ...
        deleteThreadConfirm: "¿Seguro que deseas eliminar este tema y todos sus comentarios? Esta acción no se puede deshacer.",
        threadDeleted: "Tema eliminado correctamente",
        editThreadTitle: "Editar Tema",
        ...
        threadUpdated: "Tema actualizado correctamente",
    ...
    en: {
        ...
        amountLabel_g: "Amount (grams)",
        amountLabel_ml: "Amount (milliliters)",
        unit_g: "g",
        unit_ml: "ml",
        ...
        emptySelection: "Add foods to start calculating",
        // Menu Builder
        quickStart: "Where shall we start?",
        quickStartDesc: "Select a category or search for an ingredient",
        tipPotassium: "💡 Tip: Soak legumes and tubers to reduce potassium.",
        catFruitsMenu: "Fruits",
        catVegetablesMenu: "Vegetables",
        catProteinsMenu: "Proteins",
        catDairyMenu: "Dairy",
        catCerealsMenu: "Cereals",
        catDrinksMenu: "Drinks",
        back: "Back",
        results: "Results",
        ...
        deleteThreadConfirm: "Are you sure you want to delete this thread and all its comments? This action cannot be undone.",
    ...
    de: {
        ...
        amountLabel_ml: "Menge (Milliliter)",
        unit_g: "g",
        unit_ml: "ml",
        ...
        emptySelection: "Fügen Sie Lebensmittel hinzu, um mit der Berechnung zu beginnen",
        ...
        deleteThreadConfirm: "Sind Sie sicher, dass Sie dieses Thema und alle Kommentare löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.",
        threadDeleted: "Thema erfolgreich gelöscht",
        editThreadTitle: "Thema bearbeiten",
        commentDeleted: "Kommentar gelöscht",
        saveChanges: "Änderungen speichern",
        commentUpdated: "Kommentar aktualisiert",
        commentPublished: "Kommentar gepostet",
    ...
    fr: {
        ...
        amountLabel_ml: "Quantité (millilittres)",
        unit_g: "g",
        unit_ml: "ml",
        ...
        // Footer
        medicalDisclaimer: "Avis de non-responsabilité : Cette application est un outil d'information et ne remplace pas un avis médical médical professionnel. Consultez toujours votre néphrologue.",
        ...
        emptySelection: "Ajoutez des aliments para commencer el cálculo",
        ...
        deleteThreadConfirm: "Êtes-vous sûr de vouloir supprimer ce sujet et tous ses commentaires ? Cette action est irréversible.",
        threadDeleted: "Sujet supprimé avec succès",
        editThreadTitle: "Modifier le sujet",
        ...
        threadUpdated: "Sujet mis à jour avec succès",
    ...
    pt: {
        ...
        amountLabel_ml: "Quantidade (mililitros)",
        unit_g: "g",
        unit_ml: "ml",
        ...
        emptySelection: "Adicione alimentos para começar a calcular",
        foodSearchPlaceholder: "Buscar alimento...",
        ...
        deleteThreadConfirm: "Tem certeza de que deseja excluir este tópico e todos os seus comentários? Esta ação não pode ser desfeita.",
        threadDeleted: "Tópico excluído com sucesso",
        editThreadTitle: "Editar Tópico",
        ...
        threadUpdated: "Tópico atualizado com sucesso",
    ...
    ja: {
        ...
        deleteThreadConfirm: "このトピックとそのすべてのコメントを削除してもよろしいですか？この操作は取り消せません。",
        threadDeleted: "トピックが正常に削除されました",
        editThreadTitle: "トピックを編集",
        commentDeleted: "コメントが削除されました",
        saveChanges: "変更を保存",
        commentUpdated: "コメントが更新されました",
        commentPublished: "コメントが投稿されました",
        editCommentTitle: "コメントを編集",
        threadUpdated: "トピックが正常に更新されました",
